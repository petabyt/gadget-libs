...
# Treble +3
03 00 00 40 C0 01 00 00 00 00 00 00 75 44 C3 F5 28 3F 02 00 00 40 40 00 C0 5A 45 00 00 80 3F 00 00 00 00 00 00 00 0C 43 CD CC 4C 3F 00 00 00 00 00 00 00 00 00
# Bass -6
03 00 00 40 C0 01 00 00 00 00 00 00 75 44 C3 F5 28 3F 02 00 00 40 40 00 C0 5A 45 00 00 80 3F 00 00 00 C0 C0 00 00 0C 43 CD CC 4C 3F 00 00 00 00 00 00 00 00 00
# Mid +6
03 // length?
00 00 // unknown zeros
C0 C0 01 00 00 // unknown
C0 40 00 00 75 44 C3 F5 28 3F 02 00 00
40 40 00 C0 5A 45 00 00 80 3F 00 00 00
C0 C0 00 00 0C 43 CD CC 4C 3F 00 00 00
00 00 00 00 00 00

struct EqualizerBand {
	uint8_t value; // abs(val) * 0x20
	uint8_t sign; // 0x40 positive, 0xc0 negative, 0x0 zero
	uint8_t unknown_hardcoded[11];
};

03 00 00 40 C0 01 00 00 C0 C0 00 00 75 44 C3 F5 28 3F 02 00 00 40 40 00 C0 5A 45 00 00 80 3F 00 00 00 C0 C0 00 00 0C 43 CD CC 4C 3F 00 00 00 00 00 00 00 00 00
03 00 00 00 80 01 00 00 C0 C0 00 00 75 44 C3 F5 28 3F 02 00 00 C0 C0 00 C0 5A 45 00 00 80 3F 00 00 00 C0 C0 00 00 0C 43 CD CC 4C 3F 00 00 00 00 00 00 00 00 00
03 00 00 C0 C0 01 00 00 C0 C0 00 00 75 44 C3 F5 28 3F 02 00 00 C0 40 00 C0 5A 45 00 00 80 3F 00 00 00 C0 C0 00 00 0C 43 CD CC 4C 3F 00 00 00 00 00 00 00 00 00

# +6 +6 +5
03 00 00 C0 C0
01 00 00 A0 40 00 00 75 44 C3 F5 28 3F
02 00 00 C0 40 00 C0 5A 45 00 00 80 3F
00 00 00 C0 40 00 00 0C 43 CD CC 4C 3F
